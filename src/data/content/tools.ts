...
export const toolsData: ToolContent[] = [
  ...
  },
  {
    ...
    category: "tools",
    tags: ["design", "color", "gradient"],
    type: "tool",
    platform: "web",
    thumbnail: "/images/content/tools/gradient-generator.png",
  },
  {
    id: "smooth-overlays",
    title: "Smooth Overlays",
    description: "Beautiful, smooth overlays.",
    link: "https://smooth-overlays.vercel.app/",
    category: "tools",
    tags: ["design", "color", "overlay"],
    type: "tool",
    platform: "web",
  },
];
